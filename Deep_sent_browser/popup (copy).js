...
var latlong = {};
//latlong.push({"latitude":42.5, "longitude":1.5})
...
latlong[0] = {"latitude":-20, "longitude":30};
latlong[1] = {"latitude":47, "longitude":-123};
latlong[2] = {"latitude":27, "longitude":-81};*/
var i=0;

/*while(i<3) {
	latlong[i] = {"latitude":-20 + Math.random()*(50), "longitude":30 + Math.random()*(30)};
	i++;
}*/
 ...
 function mymapfunc() {
    ...
    for (var i = 0; i < myPoints.length; i++) {
        ...
        dataProvider.images.push({
            ...
            width: size,
            height: size,
            color: getColor(1),//dataItem.color,
